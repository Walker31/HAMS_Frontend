...
const Footer = () => {
  return (
    <footer className="bg-[#fafbfc] pt-10 pb-2 border-t border-gray-200">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:justify-between gap-8">
          {/* Brand Description */}
          <div className="md:w-1/3">
            <h2 className="text-2xl font-bold mb-2">HAMSA</h2>
          ...
          <div className="flex flex-col md:flex-row gap-8 w-full md:w-2/3">
            ...
            <div>
              <h3 className=" font-semibold text-[#527C88] mb-2">Company</h3>
              <ul className="space-y-1 text-gray-700">
                <li>Home</li>
                <li>About us</li>
                <li>Services</li>
